...
test("Renders PredictedDataPage components", () => {
  ...
  getByText("On this page, you can download your new data files with both the\
            raw Apple Watch or Fitbit data, the features we use for our machine\
            learning models, and the predicted activity for each minute of your\
            data."
  );
  getByText("If you want to upload different files, go back to the file upload\
